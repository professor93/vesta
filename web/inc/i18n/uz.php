...
$LANG['en'] = array(
    ...
    'DISK'  => 'DISK',
    'NETWORK'  => 'TARMOQ',
    'Web Log Manager'  => 'Web Jurnal Boshqaruvi',

    'no notifications'  => 'Bildirishnomalar yo`q',

    'Add User'  => 'Foydalanuvchi qo`shish',
    'Add Domain'  => 'Domen qo`shish',
    'Add Web Domain'  => 'Web Domen qo`shish',
    'Add DNS Domain'  => 'DNS Domen qo`shish',
    'Add DNS Record'  => 'DNS yozuv qo`shish',
    'Add Mail Domain'  => 'Mail Domen qo`shish',
    'Add Mail Account'  => 'Mail hisob qo`shish',
    'Add Database'  => 'MB qo`shish',
    'Add Cron Job'  => 'Cron job qo`shish',
    'Create Backup'  => 'Zaxira olish',
    'Configure'  => 'Sozlash',
    'Restore All'  => 'Barchasini tiklash',
    'Add Package'  => 'Paket qo`shish',
    'Add IP'  => 'IP Manzil qo`shish',
    'Add Rule' => 'Qoida qo`shish',
    'Ban IP Address' => 'IP Manzilni ta`qiqlash',
    'Search'  => 'Izlash',
    'Add one more FTP Account' => 'Yana bitta FTP hisob qo`shish',
    'Overall Statistics'  => 'Umumiy Hisobotlar',
    'Daily'  => 'Kunlik',
    'Weekly'  => 'Haftalik',
    'Monthly'  => 'Oylik',
    'Yearly'  => 'Yillik',
    ...
    'toggle all'  => 'Barchasini almashtirish',
    'apply to selected'  => 'tanlanganlarga qo`llash',
    'rebuild'  => 'qayta tuzish',
    'rebuild web'  => 'web ni qayta tuzish',
    'rebuild dns'  => 'dns ni qayta tuzish',
    'rebuild mail'  => 'mail ni qayta tuzish',
    'rebuild db'  => 'mb ni qayta tuzish',
    'rebuild cron'  => 'cron ni qayta tuzish',
    ...
    'logout'  => 'chiqish',
    'edit'  => 'tahrir',
    'open webstats'  => 'webstats ni ochish',
    'view logs'  => 'jurnallarni ko`rish',
    'list records'  => '%s yozuvlar',
    'add record'  => 'yozuv qo`shish',
    'list accounts'  => '%s hisoblar',
    'add account'  => 'hisob qo`shish',
    'open webmail'  => 'webmail ni ochish',
    'list fail2ban' => 'fail2ban ro`yhati',
    'open %s'  => '%s ni ochish',
    'download'  => 'yuklash',
    'restore'  => 'tiklash',
    'configure restore settings'  => 'tiklash sozlovlarini sozlash',
    'stop'  => 'stop',
    'start'  => 'start',
    'restart'  => 'restart',
    'update'  => 'update',
    'generate'  => 'tuzish',
    'Generate CSR' => 'CSR tuzish',
    'reread IP' => 'reread IP',
